...
import { size ,includes,shuffle} from "lodash";
...
import { DragAndDropRunner } from "./DragAndDropRunner";
      ...
      {questions &&
        questions.map((question, qai) => {
          if (
            ...
            return (
            <div>
              {includes(question.type,"Drag") ? 
                <DragAndDropRunner question={question} converted={converted} isShowNumbering={isShowNumbering} qai={qai} answer={answer} isReview={isReview}/> :
